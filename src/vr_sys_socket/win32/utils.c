    ...
    switch (endpoint.kind) {
        case VR_Endpoint_IP_Kind_4: {
            ...
            vr_memory_copy(&ip_4->sin_addr.s_addr,
                VR_ENDPOINT_IP4_SIZE, 1, endpoint.ip_4.values);
        } break;
        ...
        case VR_Endpoint_IP_Kind_6: {
            ...
            vr_memory_copy(&ip_6->sin6_addr.s6_addr,
                VR_ENDPOINT_IP6_SIZE, 1, endpoint.ip_6.values);
        } break;
...
sockaddr_storage_t vr_win32_sockaddr_make_any(VR_Endpoint_IP_Kind kind, uint16 port)
{
    ...
    switch (kind) {
        case VR_Endpoint_IP_Kind_4: {
            ...
            vr_memory_copy(&ip_4->sin_addr.s_addr,
                VR_ENDPOINT_IP4_SIZE, 1, (void*) &in4addr_any);
        } break;
        ...
        case VR_Endpoint_IP_Kind_6: {
            ...
            vr_memory_copy(&ip_6->sin6_addr.s6_addr,
                VR_ENDPOINT_IP6_SIZE, 1, (void*) &in6addr_any);
        } break;
    ...
    switch (self->ss_family) {
        case AF_INET: {
            ...
            vr_memory_copy(result.ip_4.values,
                VR_ENDPOINT_IP4_SIZE, 1, &ip_4->sin_addr.s_addr);
        } break;
        ...
        case AF_INET6: {
            ...
            vr_memory_copy(result.ip_6.values,
                VR_ENDPOINT_IP6_SIZE, 1, &ip_6->sin6_addr.s6_addr);
        } break;
